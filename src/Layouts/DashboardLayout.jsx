...
const DashboardLayout = () => {
  const { role } = useRole();
  return (
    <div className="drawer lg:drawer-open max-w-[1440px] mx-auto bg-gray-200">
        ...
        <div className="flex min-h-full flex-col items-start bg-base-100 is-drawer-close:w-14 is-drawer-open:w-64">
          <ul className="menu w-full grow z-50">
            ...
            <li>
              ...
              >
                <TbHexagonLetterA size={22} className="text-primary" />
                <Link to="/" className="is-drawer-close:hidden font-bold">
                  Back To Home
                </Link>
              </button>
            </li>
            ...
            <li>
              ...
              >
                ...
                <Link className="is-drawer-close:hidden">Homepage</Link>
              </button>
            </li>
